...
import { HelpCenterPageContent } from '@/pages/help-center';
...
interface HelpCenterPageProps {
  content: HelpCenterPageContent;
}
const HelpCenterContainer: React.FunctionComponent<HelpCenterPageProps> = ({
  content: { viewport1, faqList, lowerText },
}) => (
  <PageWrapper>
    <FirstViewport>
      <H1>
